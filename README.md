...
1. Copy the project folder to your PHP server or run built-in server:

```powershell
php -S localhost:8000
```

2. Do NOT commit your `config.php` credentials. Update `config.php` with your DB settings.
